...
import com.example.gerenciador_tarefas.dto.request.AtribuitTarefaRequest;
...
public class TarefaController {
    ...
    public  ResponseEntity<TarefaResponseDto> atribuirTarefa(@RequestBody AtribuitTarefaRequest request){
